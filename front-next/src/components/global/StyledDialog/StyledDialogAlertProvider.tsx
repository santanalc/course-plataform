...
import { DialogAlertAtom } from "./StyledDialogHooks";
...
export default function DialogAlertProvider() {
  const [isLoading, setIsLoading] = useState(false);
  const [dialog, setDialog] = useRecoilState(DialogAlertAtom);
