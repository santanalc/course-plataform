...
import * as SC from "./ContactsSidebarFilterStyledComponents";

type ContactsSidebarFilterProps = {
  isFilterOpen: boolean;
  setIsFilterOpen: React.Dispatch<React.SetStateAction<boolean>>;
};

export default function ContactsSidebarFilter({
  isFilterOpen,
  setIsFilterOpen,
}: ContactsSidebarFilterProps) {
