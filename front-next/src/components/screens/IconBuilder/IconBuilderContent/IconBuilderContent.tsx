...
import * as SC from "./IconBuilderContentStyledComponents";
...
function IconWrapperComponent() {
  ...
  return (
    <SC.IconWrapper css={returnStyle(iconBuilder.background_type)}>
      <SC.IconContainer
        id="created-icon"
...
export default function IconBuilderContent() {
  return (
    <SC.Content style={{ padding: "0px 0px" }}>
