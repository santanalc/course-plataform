...
import * as SC from "./ContentSidebarFilterStyledComponents";

type ContentSidebarFilterProps = {
  isFilterOpen: boolean;
  setIsFilterOpen: React.Dispatch<React.SetStateAction<boolean>>;
};

export default function ContentSidebarFilter({
  isFilterOpen,
  setIsFilterOpen,
}: ContentSidebarFilterProps) {
