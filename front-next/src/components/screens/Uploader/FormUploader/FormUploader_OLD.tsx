...
import useUploadFile_OLD from "../../../../hooks/useUploadFile_OLD";
...
export default function FormUploader() {
  ...
  const { registerFile } = useUploadFile_OLD();
                  ...
                  return files
                    ? {
                        ...
                        [fileKey]: {
                          ...
                          ...(lessonData.transcodingStatus === "TRANSCODE" && {
                            status: "TRANSCODING",
                          }),
                          ...(lessonData.transcodingStatus === "ENCODE" && {
                            status: "ENCODING",
                          }),
                        },
                      }
