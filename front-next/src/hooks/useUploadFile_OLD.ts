...
export default function useUploadFile_OLD() {
  ...
  uppy.use(AwsS3Multipart, {
    limit: 10,
    companionUrl: "https://uploader-api.lrnapi.co",
  });
  ...
  uppy.on("upload-success", (file) => {
    ...
    setUploadFiles((uploadFiles) => {
      ...
      fetch(`https://encode.lrnapi.co/start_encoding`, {
        method: "POST",
        body: JSON.stringify({
          fileUrl: filePath,
        }),
        ...
        const encodeFileId = (await response.json()).job.id;
        ...
        client.mutate({
          ...
          variables: {
            ...
            virtualAppId,
            filePath,
            fileUrl: `https://ewr1.vultrobjects.com/m3u8/${encodeFileId}/master.m3u8`,
        ...
        client.mutate({
          ...
          variables: {
            ...
            data: {
              ...
              mediaUrl: `https://ewr1.vultrobjects.com/m3u8/${encodeFileId}/master.m3u8`,
            },
          },
        });
      });
